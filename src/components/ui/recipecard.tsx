...
import imgRectangle1 from "figma:asset/c98bc60599354a8a1438d4f3bfd02b9f3b93a192.png";
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        <button className="w-full bg-amber-600 hover:bg-amber-700 text-white py-4 rounded-xl transition-colors flex items-center justify-center gap-2">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
          </svg>
          <span className="font-bold">Start Cooking</span>
        </button>
      </div>
    </div>
  );
